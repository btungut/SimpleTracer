...
namespace SimpleTracer
{
    public interface ISubscription : IValidatable
    {
        ...
        /// <see cref="ISubscriptionConfigurator.WithEvents(ISourceDefinition[])"/><br></br>
        /// <see cref="ISubscriptionConfigurator.WithEvents(Action{PredefinedEventsCollector})"/>
        /// </summary>
        ...
        /// <see cref="ISubscriptionConfigurator.WithExecution(IExecution)(Action{IExecutionConfigurator})"/><br></br>
        /// <see cref="ISubscriptionConfigurator.WithExecution(Action{IExecutionConfigurator})"/>
        /// </summary>
        ...
        /// <see cref="ISubscriptionConfigurator.WithOptions"/><br></br>
        /// <see cref="ISubscriptionConfigurator.WithOptions(IOptions)"/><br></br>
        /// <see cref="ISubscriptionConfigurator.WithOptions(Action{IOptionsConfigurator})"/><br></br>
        /// </summary>
